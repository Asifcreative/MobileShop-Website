                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    <div class="slider__inner">
                                        ...
                                        <h1>Vivo S1</h1>
                                        <p>AI Super Wide-Angle Camera expands your view to 120°, so you can capture more landscape, more of your friends and a more beautiful world. In group photos, camera will automatically switch to Super Wide-Angle mode for a wider range.</p>
                                        <div class="cr__btn">
